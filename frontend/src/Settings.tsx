                    ...
                    <TabPanels>
                        ...
                        <TabPanel>
                            <Box mt="10">
                                <Center>
                                    <InputGroup w="22%" mt={10}>
                                        <Input type='text' placeholder='Insira o numero do quarto'
                                               // onChange={(e) => setRoomNumber(e.target.value)}
                                                                                                 />
                                        {/*<Button colorScheme='blue' onClick={procurarRoom}> Procurar</Button>*/}
                                    </InputGroup>
                                </Center>
                                {/*{room ? (*/}
                                {/*        <input type='text' onChange={(e) => seRoom(e.target.value)}/>*/}
